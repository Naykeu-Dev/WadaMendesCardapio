...
import { Lock, ArrowRight, Eye, EyeOff, ShieldAlert, Loader2 } from 'lucide-react';
...
export const AdminLogin: React.FC = () => {
  ...
  // 🛡️ Validação 100% Segura no Banco de Dados
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-[#09090b] flex items-center justify-center p-4">
      <form onSubmit={handleLogin} className="w-full max-w-sm bg-white dark:bg-[#121214] border border-gray-200 dark:border-zinc-800 rounded-3xl p-8 shadow-2xl text-center space-y-6 animate-in fade-in">
        ...
        <button 
          type="submit" 
          disabled={loading}
          className="w-full bg-[var(--primary-accent)] hover:opacity-95 text-white py-3.5 rounded-2xl font-black text-sm flex items-center justify-center gap-2 shadow-lg shadow-orange-500/20 active:scale-95 transition-all disabled:opacity-50"
        >
          {loading ? (
